all: libMyPeri.a buzzertest2.elf ledtest.elf fndtest.elf colorledtest.elf textlcdtest.elf buttontest.elf temperaturetest.elf bitmap1.elf
   

buzzertest2.elf: libMyPeri.a buzzer2.h buzzertest2.c
	arm-linux-gnueabi-gcc -o buzzertest2.elf buzzertest2.c -L. -lMyPeri
...
libMyPeri.a: buzzer2.h buzzer2.c fnd.h fnd.c led.h led.c colorLed.h colorLed.c button.h button.c textlcd.h textlcd.c temperature.h temperature.c bitmap.h bitmap.c
	arm-linux-gnueabi-gcc -c buzzer2.c -o buzzer2.o 
	...
	arm-linux-gnueabi-ar rc libMyPeri.a buzzer2.o led.o fnd.o colorLed.o button.o textlcd.o temperature.o bitmap.o
